    ...
    <body>
        <main>
            ...
            <form action="nameentry.php" method="post" id="nameForm">
                <fieldset>
                    <div>
                        <input id="name" name="fullName" type="text" required placeholder="Full Name" tabindex="1" title="Please enter your full name" <?php if (isset($fullName)) {
                                                                                                                                                            echo "value='$fullName'";
                                                                                                                                                        } ?>>
                    ...
                    <div>
                        <input id="email" name="email" type="email" required placeholder="email@address.com" tabindex="2" title="E-mail address must be a valid e-mail address format." <?php if (isset($clientEmail)) {
